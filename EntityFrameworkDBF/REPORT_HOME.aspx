<%@ Page Title="" Language="C#" MasterPageFile="~/VMSMaster.master" AutoEventWireup="true"
    CodeBehind="REPORT_HOME.aspx.cs" EnableEventValidation="false" Inherits="EntityFrameworkDBF.REPORT_HOME"
    Theme="Admin_Basic" %>
    ...
    <center>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlselectReport" runat="server" Style="font-weight: 700" OnSelectedIndexChanged="ddlselectReport_SelectedIndexChanged"
                        ...
                        <asp:ListItem Text="Biometric Status Report" Value="9"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlFirm" runat="server" Style="font-weight: 700">
                    </asp:DropDownList>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <div class="btnView" style="background-image: url('../images2/templatemo_button_02.png');
                        ...
                        <asp:Button ID="btnSearch" runat="server" Text="SEARCH" Visible="false" CssClass="btnView"
                ...
                <td>
                    <div class="btnView" style="background-image: url('../images2/templatemo_button_02.png');
                        background-repeat: no-repeat">
                        <asp:Button ID="Button1" runat="server" Text="SEARCH 1 " CssClass="btnView" 
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:CheckBox ID="chkunit" Text="Unit Name" runat="server" AutoPostBack="true" />
                </td>
                <td>
        ...
        <div>
            <asp:GridView ID="Gv_Demo" runat="server" PageIndex="10" AutoGenerateColumns="false"
                OnPageIndexChanging="Gv_Reports_PageIndexChanging" HeaderStyle-BackColor="#ff7e00">
                <Columns>
