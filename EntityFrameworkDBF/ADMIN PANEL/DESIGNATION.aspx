<%@ Page Title="" Language="C#" MasterPageFile="~/VMSMaster.master" AutoEventWireup="true"
    CodeBehind="DESIGNATION.aspx.cs" Inherits="EntityFrameworkDBF.ADMIN_PANEL.DESIGNATION"
    Theme="Admin_Basic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <center>
        <table>
            ...
            <tr>
                <td>
                    <asp:Label ID="lbldesig" runat="server" Text="DESIGNATION" Style="font-size: x-large;"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtdesig" runat="server" CssClass="txtView" Placeholder="Enter Designation"
    ...
    <center>
        <table>
            <tr>
                <td>
                    <div>
                        <asp:GridView ID="Gv_DesignationMaster" runat="server" AutoGenerateColumns="false"
                            AllowPaging="true" SkinID="grid1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
                            BorderWidth="1px" AlternatingRowStyle-BackColor="#ffffdd" CellPadding="3" OnPageIndexChanging="Gv_DesignationMaster_PageIndexChanging"
                            OnRowCancelingEdit="Gv_DesignationMaster_RowCancelingEdit" OnRowDeleting="Gv_DesignationMaster_RowDeleting"
                            OnRowEditing="Gv_DesignationMaster_RowEditing" OnRowUpdating="Gv_DesignationMaster_RowUpdating"
                            AutoGenerateDeleteButton="true" AutoGenerateEditButton="true" DataKeyNames="DESIGNATION_ID">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="STATE NAME">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDesigName" runat="server" Text='<%#Eval("DESIGNATION_NAME") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtDesigName" runat="server" Text='<%#Eval("DESIGNATION_NAME") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
