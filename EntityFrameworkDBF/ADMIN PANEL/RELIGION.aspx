<%@ Page Title="" Language="C#" MasterPageFile="~/VMSMaster.master" AutoEventWireup="true"
    CodeBehind="RELIGION.aspx.cs" Inherits="EntityFrameworkDBF.ADMIN_PANEL.RELIGION"
    Theme="Admin_Basic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <center>
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblReligion" runat="server" Text="RELIGION" Style="font-size: x-large;"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtReligion" runat="server" CssClass="txtView" Placeholder="Enter Religion"
    ...
    <center>
        <table>
            <tr>
                <td>
                    <div>
                        <asp:GridView ID="Gv_ReligionMaster" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                            SkinID="grid1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                            AlternatingRowStyle-BackColor="#ffffdd" CellPadding="3" OnPageIndexChanging="Gv_ReligionMaster_PageIndexChanging"
                            OnRowCancelingEdit="Gv_ReligionMaster_RowCancelingEdit" OnRowDeleting="Gv_ReligionMaster_RowDeleting"
                            OnRowEditing="Gv_ReligionMaster_RowEditing" OnRowUpdating="Gv_ReligionMaster_RowUpdating"
                            AutoGenerateDeleteButton="true" AutoGenerateEditButton="true" DataKeyNames="R_ID">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="RELIGION NAME">
                                    <ItemTemplate>
                                        <asp:Label ID="lblReligionName" runat="server" Text='<%#Eval("R_NAME") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtReligionName" runat="server" Text='<%#Eval("R_NAME") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
