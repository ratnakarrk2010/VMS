<%@ Page Title="" Language="C#" MasterPageFile="~/VMSMaster.master" AutoEventWireup="true"
    CodeBehind="STATE.aspx.cs" Inherits="EntityFrameworkDBF.ADMIN_PANEL.STATE" Theme="Admin_Basic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <center>
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblstate" runat="server" Text="STATE" Style="font-size: x-large;"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtstate" runat="server" CssClass="txtView" Placeholder="Enter State"
    ...
    <center>
        <table>
            <tr>
                <td>
                    <div>
                        <asp:GridView ID="Gv_StateMaster" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                            SkinID="grid1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                            AlternatingRowStyle-BackColor="#ffffdd" CellPadding="3" OnPageIndexChanging="Gv_StateMaster_PageIndexChanging"
                            OnRowCancelingEdit="Gv_StateMaster_RowCancelingEdit" OnRowDeleting="Gv_StateMaster_RowDeleting"
                            OnRowEditing="Gv_StateMaster_RowEditing" OnRowUpdating="Gv_StateMaster_RowUpdating"
                            AutoGenerateDeleteButton="true" AutoGenerateEditButton="true" DataKeyNames="STATE_ID">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="STATE NAME">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtStateName" runat="server" Text='<%#Eval("STATE_NAME") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
