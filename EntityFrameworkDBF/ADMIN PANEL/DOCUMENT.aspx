<%@ Page Title="" Language="C#" MasterPageFile="~/VMSMaster.master" AutoEventWireup="true"
    CodeBehind="DOCUMENT.aspx.cs" Inherits="EntityFrameworkDBF.ADMIN_PANEL.DOCUMENT"
    Theme="Admin_Basic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <center>
        <table>
            <tr>
                <td>
                    <asp:Label ID="lbldocumnet" runat="server" Text="DOCUMNET " Style="font-size: x-large;"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtdocumnet" runat="server" CssClass="txtView" Placeholder="Enter Document Title"
    ...
    <center>
        <table>
            <tr>
                <td>
                    <div>
                        <asp:GridView ID="Gv_DocumentMaster" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                            SkinID="grid1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                            AlternatingRowStyle-BackColor="#ffffdd" CellPadding="3" OnPageIndexChanging="Gv_DocumentMaster_PageIndexChanging"
                            OnRowCancelingEdit="Gv_DocumentMaster_RowCancelingEdit" OnRowDeleting="Gv_DocumentMaster_RowDeleting"
                            OnRowEditing="Gv_DocumentMaster_RowEditing" OnRowUpdating="Gv_DocumentMaster_RowUpdating"
                            AutoGenerateDeleteButton="true" AutoGenerateEditButton="true" DataKeyNames="DOCUMENT_ID">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="DOCUMENT NAME">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtDocumentName" runat="server" Text='<%#Eval("DOCUMENT_NAME") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
