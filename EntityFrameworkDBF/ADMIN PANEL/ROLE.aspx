<%@ Page Title="" Language="C#" MasterPageFile="~/VMSMaster.master" AutoEventWireup="true"
    CodeBehind="ROLE.aspx.cs" Inherits="EntityFrameworkDBF.ADMIN_PANEL.ROLE" Theme="Admin_Basic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <center>
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblRole" runat="server" Text="ROLE" Style="font-size: x-large;"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtRole" runat="server" CssClass="txtView" Placeholder="Enter Role"
    ...
    <center>
        <table>
            <tr>
                <td>
                    <div>
                        <asp:GridView ID="Gv_RoleMaster" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                            SkinID="grid1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                            AlternatingRowStyle-BackColor="#ffffdd" CellPadding="3" OnPageIndexChanging="Gv_RoleMaster_PageIndexChanging"
                            OnRowCancelingEdit="Gv_RoleMaster_RowCancelingEdit" OnRowDeleting="Gv_RoleMaster_RowDeleting"
                            OnRowEditing="Gv_RoleMaster_RowEditing" OnRowUpdating="Gv_RoleMaster_RowUpdating"
                            AutoGenerateDeleteButton="true" AutoGenerateEditButton="true" DataKeyNames="ROLEID">
                            <Columns>
