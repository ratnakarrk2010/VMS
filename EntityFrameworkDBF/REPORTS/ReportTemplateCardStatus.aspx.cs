...
{
    public partial class ReportTemplateCardStatus : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                using (SqlCon)
                {
                    using (SqlDataAdapter da = new SqlDataAdapter())
                    {
                        ...
                        SqlCmd.Parameters.AddWithValue("@Dcommand", dlCardCommand.SelectedItem.Value);
                        SqlCmd.CommandText = "dbo.ReptTemplateCardStatus";
        ...
        protected void ddlselectReport_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Response.Redirect("REPORT_HOME.aspx", false);
                }
            }
            catch (Exception)
            {
