<%@ Page Title="" Language="C#" MasterPageFile="~/VMSMaster.master" AutoEventWireup="true"
    CodeBehind="TemplateCardStatus.aspx.cs" Inherits="EntityFrameworkDBF.REPORTS.TemplateCardStatus"
    Theme="Admin_Basic" %>
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:GridView ID="GvContoller" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                                        ...
                                        AlternatingRowStyle-BackColor="#ffffdd" OnPageIndexChanging="GvContoller_PageIndexChanging" CellPadding="3" PageSize="10" Visible="false">
                                        <Columns>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
